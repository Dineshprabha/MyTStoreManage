package com.dineshprabha.mytstoremanage
...
import com.dineshprabha.mytstoremanage.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
        ...
        binding.apply {
            ...
            buttonSave.setOnClickListener {
                ...
                if (!productValidation){
                    Toast.makeText(this@MainActivity, "Check Your inputs", Toast.LENGTH_SHORT)
                }
                saveProduct()
            }
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        if (item.itemId == R.id.saveProduct){
            ...
            if (!productValidation){
                Toast.makeText(this, "Check Your inputs", Toast.LENGTH_SHORT)
                return false
            }
    ...
    private fun getImagesByteArrays(): List<ByteArray> {
        val imgaeByteArray = mutableListOf<ByteArray>()
        selectedImages.forEach {
            val stream = ByteArrayOutputStream()
            val imageBmp = MediaStore.Images.Media.getBitmap(contentResolver, it)
            if (imageBmp.compress(Bitmap.CompressFormat.JPEG, 100, stream)){
                imgaeByteArray.add(stream.toByteArray())
            }
        }
        return imgaeByteArray
